          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              <motion.h1
                ...
                className="text-5xl sm:text-7xl lg:text-[5.5rem] font-black tracking-tighter mb-6 text-white drop-shadow-2xl leading-[1.05]"
              >
                Play Anywhere. <br />
              ...
              >
                <a href="https://play.google.com/store/apps/details?id=com.turfcut.app" target="_blank" rel="noopener noreferrer" className="flex-1 cursor-pointer">
                  <Button className="w-full h-14 sm:h-16 text-sm sm:text-lg font-bold bg-white text-black hover:bg-white/90 rounded-2xl group transition-all whitespace-nowrap px-2 sm:px-6 cursor-pointer">
            ...
            >
              <div className="absolute inset-0 bg-brand-mint/20 blur-[100px] rounded-full w-[400px] h-[400px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0"></div>
              <Link href="/owner/dashboard" className="relative z-10 w-full max-w-[550px] cursor-pointer">
                <img
                  src="/images/hero-phones.png"
                  alt="TurfPlay App Preview"
                  className="w-full object-contain drop-shadow-[0_30px_50px_rgba(0,0,0,0.5)] transform -rotate-2 hover:rotate-0 transition-transform duration-700 ease-out rounded-[3rem]"
                />
              </Link>
            </motion.div>
          </div>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-brand-dark-green relative z-10 border-t border-white/5">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-[3rem] p-10 sm:p-14 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-64 h-64 bg-brand-caribbean/10 rounded-full blur-[80px] pointer-events-none" />
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="bg-gradient-to-bl from-white/5 to-white/0 border border-white/10 rounded-[3rem] p-10 sm:p-14 relative overflow-hidden group">
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-mint/10 rounded-full blur-[80px] pointer-events-none" />
              ...
              <div className="flex gap-4 mb-8">
                <Link href="/owner/dashboard" className="relative z-10 cursor-pointer inline-flex items-center justify-center h-12 px-6 font-bold bg-brand-mint text-brand-dark-green hover:bg-white rounded-xl transition-colors">
                  List Your Turf
                </Link>
              </div>
        ...
        <footer className="w-full pt-20 pb-10 px-6 sm:px-12 bg-black/80 backdrop-blur-2xl relative z-10 border-t border-brand-mint/20">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-5 gap-y-12 gap-x-6 sm:gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-white/50 text-sm font-medium">
                <li><Link href="/owner/dashboard" className="hover:text-brand-mint hover:translate-x-1 transition-all inline-block cursor-pointer">List Your Turf</Link></li>
              </ul>
            </div>
